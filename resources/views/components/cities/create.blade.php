                                ...
                                <div class="col-xxl-6 col-lg-12">
                                    <div class="dashboard__card bg__white padding-20 radius-10">
                                        <div class="dashboard__card__header">
                                            <h4 class="dashboard__card__header__title">Create City Form</h4>
                                        </div>
                                            ...
                                            <div class="form__input">
                                                <form id="cityForm" action="#">
                                                    <div class="form__input__single">
                                                        ...
                                                        <input type="text" id="city_name" name="city_name" class="form__control radius-5" placeholder="City Name...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label for="population" class="form__input__single__label">City Population</label>
                                                        <input type="text" id="population" name="population" class="form__control radius-5" placeholder="Population...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label for="area" class="form__input__single__label">City Area</label>
                                                        <input type="text" id="area" name="area" class="form__control radius-5" placeholder="Area...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label class="form-label">State</label>
                                                        <select type="text" class="form-control form-select" name="state_id" id="stateSelect">
