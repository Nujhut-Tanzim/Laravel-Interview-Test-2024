...
<body>
                                ...
                                <div class="col-xxl-6 col-lg-12">
                                    <div class="dashboard__card bg__white padding-20 radius-10">
                                        <div class="dashboard__card__header">
                                            <h4 class="dashboard__card__header__title">Update State Details</h4>
                                        </div>
                                        <div class="dashboard__card__inner mt-4">
                                            <div class="form__input">
                                                <form id="stateUpdateForm" enctype="multipart/form-data" action="#">
                                                    <div class="form__input__single">
                                                        <input type="text" id="id" name="id" class="form__control radius-5" value="{{$id}}" style="display:none;">
                                                        <label for="updated_state_name" class="form__input__single__label">State Name</label>
                                                        <input type="text" id="updated_state_name" name="updated_state_name" class="form__control radius-5" placeholder="State Name...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label for="updated_area" class="form__input__single__label">State Area</label>
                                                        <input type="text" id="updated_area" name="updated_area" class="form__control radius-5" placeholder="State Area...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label class="form-label">Country</label>
                                                        <select type="text" class="form-control form-select" name="country_id" id="updatedcountrySelect">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (stateId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#updated_state_name').val(data.state_name);
                        $('#updated_area').val(data.area);
                        loadcountry(data.country_id);
                ...
                $.ajax({
                    ...
                    success: function(countries) {
                        countries.forEach(function(country) {
                            ...
                            $('#updatedcountrySelect').append(option);
                        });

                        $('#updatedcountrySelect').val(id);
                    },
                    error: function() {
            ...
            $('#stateUpdateForm').on('submit', function(e) {
                e.preventDefault();
                const name = $('#updated_state_name').val().trim();
                const country = $('#updatedcountrySelect').val().trim();
                ...
                if (name === "") {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            alert("State Detail update successfully.");
                        },
                        error: function(xhr) {
                            // Handle error
