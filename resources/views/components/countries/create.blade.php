...
<body>
                                ...
                                <div class="col-xxl-6 col-lg-12">
                                    <div class="dashboard__card bg__white padding-20 radius-10">
                                        <div class="dashboard__card__header">
                                            <h4 class="dashboard__card__header__title">Create Country Form</h4>
                                        </div>
                                        <div class="dashboard__card__inner mt-4">
                                            <div class="form__input">
                                                <form id="countryForm" action="#">
                                                    <div class="form__input__single">
                                                        <label for="country_name" class="form__input__single__label">Country Name</label>
                                                        <input type="text" id="country_name" name="country_name" class="form__control radius-5" placeholder="Country Name...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        <label for="code" class="form__input__single__label">Country Code</label>
                                                        <input type="text" id="code" name="code" class="form__control radius-5" placeholder="Country Code...">
                                                    </div>
                                                    <div class="form__input__single">
                                                        ...
                                                        <br>
                                                        <!-- Image preview -->
                                                        <img id="flagImagePreview" alt="Flag Preview" style="display:none; max-width: 200px; margin-top: 10px;">
    ...
    <script>
        function previewImage(event) {
            ...
            const preview = document.getElementById('flagImagePreview');
                ...
                if (name === "") {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            ...
                            $('#countryForm')[0].reset();
                            $('#flagImagePreview').hide(); // Hide preview after reset
                        },
                        error: function(xhr) {
