                                        ...
                                        <div class="dashboard__inner__header">
                                            <div class="dashboard__inner__header__flex">
                                                <div class="dashboard__inner__header__left">
                                                    <h4 class="dashboard__inner__header__title"> Good Morning, {{ Auth::check() ? Auth::user()->name : 'Guest' }}</h4>
                                                                    ...
                                                                    <div class="dashboard__recentActivities__single">
                                                                        <div class="dashboard__recentActivities__single__flex">
                                                                            ...
                                                                            <div class="dashboard__recentActivities__single__contents">
                                                                                @foreach ($activities as $activity)
                                                                                <h6 class="dashboard__recentActivities__single__title"><a href="javascript:void(0)">{{ $activity->user->name }} {{ $activity->action }} a {{ $activity->entity_type }}</a></h6>
                                                                                <p class="dashboard__recentActivities__single__time mt-2">{{ $activity->created_at->format('Y-m-d H:i') }}</p>
                                                                                @endforeach
                                            ...
                                            <div class="row g-4 mt-2">
                                                <div class="col-xxl-3 col-xl-4 col-sm-6">
                                                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                                        ...
                                                        <h4 class="dashboard_promo__single__price mt-2">{{$totalCountries}}</h4>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-xl-4 col-sm-6">
                                                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                                        <span class="dashboard_promo__single__subtitle">Total States</span>
                                                        <h4 class="dashboard_promo__single__price mt-2">{{$totalstates}}</h4>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-xl-4 col-sm-6">
                                                    <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                                        <span class="dashboard_promo__single__subtitle">Total Cities</span>
                                                        <h4 class="dashboard_promo__single__price mt-2">{{$totalCities}}</h4>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-3 col-xl-4 col-sm-6">
                                                </div>
                                        ...
                                        <div class="row g-4 mt-1">
                                            <div class="col-lg-12">
                                                <div class="dashboard__card bg__white padding-20 radius-10">
                                                    <h5 class="dashboard__card__header__title">Total List</h5>
