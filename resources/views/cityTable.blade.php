                    ...
                    <div class="dashboard__body">
                        <div class="dashboard__inner">
                            <div class="dashboard__inner__item dashboard__card bg__white padding-20 radius-10">
                                ...
                                @include('components.cities.view')
                                <!-- End-of Table one -->
                            </div>
                        </div>
                    </div>
                            ...
                            <td>
                                ...
                                <div class="dropdown custom__dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton7">
                                           <li><a class="dropdown-item view-details"data-id="${city.id}">View</a></li>
                                        <li><a class="dropdown-item"  href="/cities/${city.id}/edit">Edit</a></li>
                                        <li><a class="dropdown-item delete_details" data-id="${city.id}">Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
