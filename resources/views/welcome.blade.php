                ...
                <div class="dashboard__right">
                    <div class="dashboard__header single_border_bottom">
                        <div class="row gx-4 align-items-center justify-content-between">
                            ...
                            <!-- Right Section: Login, Register, Mode Change -->
                            <div class="col-sm-10 d-flex justify-content-end align-items-center">
                                <div class="dashboard__header__author d-flex align-items-center" style="color: black;">
                                    @auth
                                    <a href="{{ route('dashboard') }}" style="color:orange;">Dashboard</a>
                                    @else
                                    <a href="{{ route('login') }}" style="color:orange;margin-right:15px;"><b>Login</b></a>
                                    <a href="{{ route('register') }}" style="color:orange;"><b>Register</b></a>
                                    @endauth
                                </div>

                                <!-- Mode Change Button -->
                                <div class="dashboard__header__right__item ml-4">
                                    <a href="javascript:void(0)" id="mode_change">
                    ...
                    <div class="dashboard__body posPadding">
                        <div class="dashboard__inner d-flex justify-content-center align-items-center">
                            <div class="dashboard__inner__item text-center">
                                <div class="dashboard__inner__item__flex">
                                    <div class="dashboard__inner__item__left bodyItemPadding">
                                        <div class="dashboard__inner__header">
                                            <div class="dashboard__inner__header__flex">
                                                <div class="dashboard__inner__header__left">
                                                    <h4 class="dashboard__inner__header__title">Welcome to our platform</h4><br>
                                                    <p class="dashboard__inner__header__para"> If you are new, we encourage you to register first to unlock all the features we offer. We are thrilled to have you on board and are here to make your experience smooth and enjoyable.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
