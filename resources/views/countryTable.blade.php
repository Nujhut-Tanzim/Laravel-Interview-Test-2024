                    ...
                    <div class="dashboard__body">
                        <div class="dashboard__inner">
                            <div class="dashboard__inner__item dashboard__card bg__white padding-20 radius-10">
                                ...
                                @include('components.countries.view')
                                <!-- End-of Table one -->
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '.searchForm', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        const tbody = $('#countriesTable');
                        tbody.empty(); // Clear existing rows
                        data.forEach((country, index) => {
                            let flagImage = country.flag_image ? country.flag_image : "{{ asset('html/assets/download.png') }}";
                            tbody.append(`
                        <tr>
                            <td>${index+1}</td>
                            
                            <td><img src="${flagImage}" alt="${country.country_name} Flag" width="50"></td>
                            ...
                            <td>
                                ...
                                <div class="dropdown custom__dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton7">
                                           <li><a class="dropdown-item view-details"data-id="${country.id}">View</a></li>
                                        <li><a class="dropdown-item"  href="/countries/${country.id}/edit">Edit</a></li>
                                        <li><a class="dropdown-item delete_details" data-id="${country.id}">Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
            ...
            $(document).on('click', '.view-details', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#flagImagePreview').attr('src', flagImageUrl).show();
            ...
            $(document).on('click', '.delete_details', function(e) {
                ...
                if (confirm('Are you want to delete this country?')) {
                    $.ajax({
                        url: `/countries/${countryId}`,
                        method: 'DELETE',
                        headers: {
